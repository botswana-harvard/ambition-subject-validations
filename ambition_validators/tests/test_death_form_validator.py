...
class TestDeathFormValidations(TestCase):
    ...
    def test_cause_of_death_study_doc_opinion_other(self):
        ...
        form_validator = DeathFormValidator(cleaned_data=cleaned_data)
        self.assertRaises(ValidationError, form_validator.validate)
        self.assertIn(
            'cause_other_study_doctor_opinion', form_validator._errors)
    ...
    def test_cause_of_death_study_doc_opinion_yes(self):
        ...
        form_validator = DeathFormValidator(cleaned_data=cleaned_data)
        self.assertRaises(ValidationError, form_validator.validate)
        self.assertIn('cause_tb_study_doctor_opinion', form_validator._errors)
    ...
    def test_cause_of_death_study_tmg1_tb_no_site_specified_invalid(self):
        ...
        form_validator = DeathFormValidator(cleaned_data=cleaned_data)
        self.assertRaises(ValidationError, form_validator.validate)
        self.assertIn('cause_tb_tmg1_opinion', form_validator._errors)
    ...
    def test_cause_of_death_study_tmg2_tb_no_site_specified_invalid(self):
        ...
        form_validator = DeathFormValidator(cleaned_data=cleaned_data)
        self.assertRaises(ValidationError, form_validator.validate)
        self.assertIn('cause_tb_tmg2_opinion', form_validator._errors)
